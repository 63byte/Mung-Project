    ...
    <c:choose>
        ...
        <div class="row-item">
            <div class="viewInfo iconArea" style="margin-left: 1020px;">
                ...
                <div class="count">${room.viewCount }</div><!-- 최대 999,999 -->
            </div>  
        </div>
        ...
        <div class="row-item" >
            ...
            <span id="roomAddress">숙소 주소    : ${room.location2 }  </span>
        </div> 
    
        <!-- 숙소 전화번호 -->
        <div class="row-item" >
            <span><img class="icon" src="${contextPath}/resources/image/icon/phone.png"></span>
            <span id="roomPhone">전화번호    : ${room.phone } </span>
        </div> 
        ...
        <c:if test="${!empty loginMember && (loginMember.memberAdmin == 'C' && room.memNo == loginMember.memberNo) || loginMember.memberAdmin == 'A'}">
	        <div class="row-item" style="margin-top:50px;">
	            <div class="btn_item">
	                ...
	                <a href="updateForm?cp=${param.cp}&roomNo=${param.roomNo}${searchStr}" 

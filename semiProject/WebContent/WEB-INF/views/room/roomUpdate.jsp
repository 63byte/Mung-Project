...
<c:set var="phone" value="${fn:split(room.phone,'-') }"/>
    ...
    <div class="wrapper">
		...
		<c:if test="${!empty param.sk && !empty param.sv}">
            ...
            <div class="insert_room">
                <form action="${contextPath}/room/update?cp=${param.cp}&roomNo=${param.roomNo}${searchStr}" method="post" 
                	enctype="multipart/form-data"  role="form" onsubmit="return roomUpdateValidate();">
                    ...
                    <div class="row-item">
                        ...
                        <div class="input_tag">
                            <select class="full_input" id="location1" name="loaction1" required>
                    ...
                    <div class="row-item">
                        ...
                        <div class="input_tag">
                            ...
                            &nbsp;-&nbsp;&nbsp;
                            <input type="number" class="phone" id="phone2" name="phone2" value="${phone[1] }"  required>
                            &nbsp;-&nbsp;
                            <input type="number" class="phone" id="phone3" name="phone3" value="${phone[2] }"  required>
                        </div>
                    </div>
                    ...
                    <div class="row-item">
                        ...
                        <div class="input_tag">
                            <input type="text" class="full_input" id="location2" name="location2" value="${room.location2 }" autocomplete="off" required>
                        </div>
                    </div>
                    ...
                    <div class="row-item">
                        ...
                        <div class="input_tag">
                            <input type="text" class="checkHours" id="checkIn" name="checkin"  value="${room.checkin }" autocomplete="off" required>
                            &nbsp;/
                            <input type="text" class="checkHours" id="checkOut" name="checkout"  value="${room.checkout }" autocomplete="off" required>
                        </div>
                    </div>

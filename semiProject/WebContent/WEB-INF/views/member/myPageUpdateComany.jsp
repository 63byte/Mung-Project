                ...
                <form action="#" method="POST" onsubmit="return memberChangevalidate();">
                    <div class="memberChange">
                        ...
                        <div>
                            ...
                            <div class="ip">
                                <input type="text" class="inputTag display-ib email" id="email1" autocomplete="off"
                                    required>
                                @
                        ...
                        <div class="row mb-3 form-row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control postcodify_address inputTag" name="address1"
                                    id="address1">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 form-row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control postcodify_details inputTag" name="address2"
                                    id="address2">
                            </div>
                            <div>
                                <br>

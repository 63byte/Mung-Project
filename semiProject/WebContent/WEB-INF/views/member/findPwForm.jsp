...
<c:set var="contextPath" scope="application"
	...
	<div id="wrapper">
        <div id="logoDiv" style="width: 150px; height: 300px">
            <a href="${contextPath}"><img src="${pageContext.request.contextPath}/resources/image/common/logo.png" id="logo"></a>
        </div>
        ...
        <div id="findWrapper">
      <form action="${contextPath}/member/findPwReady.do" method="post" onsubmit="return submitCheck();">
        <div id="findDiv1">
        ...
        <div id="findDiv2">
            ...
            <input type="text" id="inputEmail" placeholder="인증번호 입력" required>
